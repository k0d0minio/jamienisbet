...
// monogram, sitting on the trailing edge of every screen's compact title bar.
// The wordmark stopped leading each page when the screen's own name took that
// job — the monogram is what remains of it, and it is where anything that
// belongs to the app rather than to a screen lives. Today that is sign out;
// the sheet is a list because the next one will just be another row.
//
// Phones only. From `md` up the sidebar carries the monogram and sign out
// outright, and a second copy in the bar would be one sign-out too many.
