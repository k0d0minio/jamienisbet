// English dictionary — the canonical source of every translatable string on the
// affiliate site. Its shape (`Dictionary`) is the contract the other locales
// must satisfy. Facts come from workspaces/lead-generation/references/; voice
// follows _config/brand/voice/ — plain, warm, no jargon. Locale-invariant config
// (name, email, urls, icons, hrefs) stays in lib/site.ts, not here.
//
// `{link}` in a ready-to-send message is replaced at render time with the share
// link. `{location}`, `{site}`, `{code}`, `{email}` are filled the same way.

export const en = {
  ogLocale: "en_GB",

  // Used both as the program label/eyebrow and as the metadata title suffix.
  ...
  footer: {
    tagline:
      "Refer web and software work, earn 10% on what gets built — paid when the client pays. Run from {location}.",
  ...
  hero: {
    title: "Earn 10% sending me work you already talk about.",
    intro:
      "Someone you know needs a website? Make the intro. I scope it, build it, and ship it — you earn 10% of what I invoice, paid when the client pays. No tech knowledge needed, no risk on you.",
    refer: "Refer a customer",
    how: "How it works",
  },
  ...
  howItWorks: {
    ...
    intro:
      "You bring the relationship. I do the rest — and the referral code keeps the 10% unambiguously yours.",
    steps: [
      {
        key: "refer",
        title: "You refer",
  ...
  whatYouSell: {
    ...
    intro:
      "Landing pages you can quote yourself, from €200. Anything bigger, just introduce me — you still earn your 10%.",
    points: [
      {
        key: "landing",
  ...
  salesKit: {
    ...
    intro:
      "Copy a message, send it, log the lead. No pitch to memorise, no tech to explain — that part's on me.",
    pitchCard: {
      title: "The customer pitch page",
      body: "A clean page that sells the work, not the program — show it on your phone or send the link. It prints to a one-pager too.",
      cta: "Open the pitch",
    },
    readyEyebrow: "Ready-to-send messages",
    readyNoteWithCode:
      "Each message links to {site} — the page customers see. Log the lead below with your code {code} to keep the 10% yours.",
    readyNote:
      "Each message links to {site} — the page customers see. Log the lead below with your referral code to keep the 10% yours.",
    followEyebrow: "Follow up — where most referrals close",
    followNote:
      "Three light touches, then stop. A warm “later” is worth more than a pushed “no”.",
    objectionsEyebrow: "If they hesitate",
    packagesEyebrow: "What you can quote — and what to hand me",
    leadsEyebrow: "What makes a lead worth sending",
    earningsEyebrow: "What your 10% looks like",
    table: {
      work: "The work",
      pays: "Client pays",
      earn: "You earn",
    ...
    earningsNote:
      "Examples only — your 10% is always 10% of what the client actually pays, settled once their payment lands.",
  },

  // Ready-to-send messages. `{link}` becomes the share link at render time.
  pitchScripts: [
    {
      key: "whatsapp",
      channel: "WhatsApp",
  ...
  // The follow-up sequence. `{link}` becomes the share link at render time.
  followUps: [
    {
      key: "sameday",
      when: "Same day",
  ...
  refer: {
    eyebrow: "Refer",
    title: "Log a lead. Keep it yours.",
    intro:
      "Drop in your referral code and the lead's details — I'll reply within a day or two.",
    firstWins:
      "The first valid referral code on a new customer wins — so log it here before anyone else does.",
  ...
  form: {
    ...
    botSuccess: "Thanks — that's logged.",
    ...
    customerEmail: "Lead email (optional)",
    need: {
      label: "What do they need?",
      placeholder:
        "One line — e.g. a one-page site with a contact form for a new café.",
    },
    budget: {
      label: "Rough budget (optional)",
      placeholder: "Pick a range, or leave it to me",
    },
    callTime: {
    ...
    submit: "Send lead",
    submitting: "Sending…",
    // Keys match the canonical budget values in lib/referral-schema.ts.
    budgetOptions: {
    ...
    errors: {
      referralCodeMin: "Your referral code — it's what ties the payout to you.",
      customerNameMin: "The customer's name, please.",
      phoneMin: "A phone number so I can reach them.",
      phoneInvalid: "That phone number doesn't look right.",
      emailInvalid: "That email doesn't look right.",
      needMin: "One line on what they need, please.",
      needMax: "That's a lot — trim it to the essentials.",
      slotInvalid: "Pick a slot from the list — business days, 9am to 5pm.",
    },
  },

  pitch: {
    metaTitle: "Your website, built properly",
    metaDescription:
    ...
    getTitle: "Start simple. Grow when it's worth it.",
    getIntro:
      "A clean landing page to begin, with room to add pages, a booking system, or an AI feature later — only when it earns its keep.",
    whyEyebrow: "Why me",
    ...
    ctaHeading: "Let's get your site live.",
    ctaBody:
  ...
  notFound: {
    ...
    body: "The link might be old or mistyped. Let's get you back on track.",
    cta: "Back home",
  },
}

// The English dictionary is the canonical shape every locale must satisfy.
