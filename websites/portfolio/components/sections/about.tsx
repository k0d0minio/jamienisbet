        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 text-lg text-muted-foreground">
            <p>
              ...
              {site.location}. I&apos;ve spent years building software for the web — and lately,
              putting AI to work inside it where it genuinely helps.
            </p>
            <p>
            ...
            <p>
              I care about doing the useful thing, explaining the why, and being straight about
              trade-offs and cost. If something&apos;s a bad idea, I&apos;ll tell you.
            </p>
          </div>
