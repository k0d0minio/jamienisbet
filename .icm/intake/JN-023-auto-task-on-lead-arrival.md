...
In `projects/jamienisbet/websites/portfolio/app/actions/contact.ts` and
`projects/jamienisbet/websites/sellers-site/app/actions/referral.ts`, after `createClientFromContact` /
`createClientFromReferral` succeeds, call `createTask` from `projects/jamienisbet/packages/services`
...
projects/jamienisbet/websites/portfolio/app/actions/contact.ts and
projects/jamienisbet/websites/sellers-site/app/actions/referral.ts, calling createTask from
projects/jamienisbet/packages/services after the lead persists; non-fatal on failure. Open a PR on a claude/
