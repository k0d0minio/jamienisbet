...
- depends-on: none
- sequence: 1 of 1
- blocked: waits for icm-board's D37 (`ticket-base-branch/ticket-base-contract`) — the wording of
...
sessions to push tickets to `main`, which D37 retires for client repos.
...
- Rewrite the three maintenance prompts to D37's ticket PR (branch `claude/tickets-…`, label
...
evidence and the file/line list (`websites/admin-dashboard/lib/tickets.ts`), and icm-board's D37
