...
- **Downstream / feeds:** a new `workspaces/<name>/` capability; that capability's final stage `output/` typically feeds [`shared/clients/`](../../shared/clients/) or a per-project pipeline under [`projects/`](../../projects/).
