...
## Contents
- `questionnaire.md` — *(planned, do not create yet)* the fill-in-the-blanks config: capability name & one-line purpose; trigger (what starts a run); inputs/outputs; success criteria; which Layer 3 references apply; review-gate owner; cadence (per-lead, weekly, on-demand).
