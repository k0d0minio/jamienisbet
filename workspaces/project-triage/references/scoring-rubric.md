...
> **ICM role:** Layer 3 — reference (project-triage). Score each dimension 0–5; weights live in setup.
...
- **5** — healthy budget above standard; value-based upside.

### Strategic value (weight 25%)
What it builds beyond the fee.
- **0** — one-off grind, nothing beyond the cheque.
- **3** — a decent case study or a good client.
