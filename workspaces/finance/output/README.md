...
- **Downstream / feeds:** the founder review gate; his contabilista certificado; [`workspaces/legal-and-tax/`](../../legal-and-tax/) (period figures); [`tracker/`](../../../tracker/) (reminders derived from receivables and deadlines).
