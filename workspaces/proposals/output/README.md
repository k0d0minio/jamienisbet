...
- **Downstream / feeds:** [`workspaces/finance/`](../../finance/) (on invoice); [`projects/`](../../../projects/) (new delivery pipeline once signed); [`shared/clients/`](../../../shared/clients/) (deal status)
...
## Notes
One folder per deal keeps runs isolated and reviewable (Principle 4 — every output is an edit surface). Use a consistent client slug so `shared/clients/` and `projects/` line up. Any financial or contractual file here is decision-support and must be confirmed by a licensed Portuguese contabilista certificado / lawyer before it is acted on.
