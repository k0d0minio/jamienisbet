...
- **Upstream / reads from:** human input (a new lead); the client record in [`shared/clients/`](../../shared/clients/)
- **Downstream / feeds:** [`workspaces/finance/`](../finance/) on close (via stage `07_invoice`); a per-project delivery pipeline in [`projects/`](../../projects/) once the deal is signed
