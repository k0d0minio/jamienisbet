...
> **Purpose:** Generate the recurring filing deadlines for the chosen structure, as a reviewed markdown calendar whose entries Jamie enters into the dashboard's compliance calendar (`biz.compliance_dates`).
...
- **Downstream / feeds:** the dashboard's compliance calendar (deadline surfacing in the morning brief); [`workspaces/finance/`](../../../finance/) (filing/payment scheduling)
