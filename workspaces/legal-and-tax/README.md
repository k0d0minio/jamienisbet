...
- **Downstream / feeds:** the dashboard's compliance calendar (deadlines), [`workspaces/finance/`](../finance/) (regime, deductibles, invoicing structure), and updates back to [`_config/business/`](../../_config/business/) once the entity exists
